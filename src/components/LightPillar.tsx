...
color += rnd / 25.0 * uNoiseIntensity;  // add instead of subtract

        vec3 background = vec3(1.0); // PURE WHITE
float strength = clamp(length(color), 0.0, 1.0);
vec3 finalColor = mix(background, color * uIntensity, strength);
